    ...
    <div className="min-h-screen bg-black text-white p-6">
      ...
      {lang === 'uk' ? (
        <div className="space-y-4 text-gray-200 text-sm">
          <p><strong>1. Загальні положення:</strong> Компанія  ExpressPhoto Online офіційно - "EXPRESS PHOTO DARIIA KRAVETS" надає послуги друку, фотографування, сканування, ламінування та копіювання документів.</p>
