...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black text-white p-6 relative overflow-hidden">
      ...
      <AnimatePresence>
        {showInfo && (
          <motion.div className="fixed inset-0 bg-black bg-opacity-90 flex flex-col items-center justify-center text-center p-6 z-50 overflow-y-auto" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
              ...
              {language === 'uk' ? (
                <>
                  ...
                  <ul className="list-disc pl-5 text-left space-y-1">
                    <li>Фотосесії (портретні, вагітність, народження, групові)</li>
                    <li>Весільні та заручальні фотосесії</li>
                    <li>Відновлення та ретуш фотографій</li>
                    <li>Ксерокопії ч/б і кольорові (A3, A4)</li>
                    <li>Ламінування документів</li>
                    <li>Сканування документів</li>
                    <li>Друк фотографій і документів</li>
                  </ul>
                  <p className="mt-4">Телефон: +48 609 860 816</p>
                ...
                <>
                  ...
                  <p className="mt-4">Telefon: +48 609 860 816</p>
      ...
      <p className="text-sm text-gray-500 mt-10 text-center">
        {t('address')}<br />{t('phone')}<br />{t('emailCompany')}
      </p>
    </div>
  );
}
